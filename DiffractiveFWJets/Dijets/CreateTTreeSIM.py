...
# START3X_V26 (pomwig)
# START38_V9::All (Old) - pythia
# START38_V12 working pythia
if (config.runOnMC):
...
process.hltJets.TriggerResultsTag = cms.InputTag("TriggerResults","","REDIGI38XPU")
...
uiworkingdir = '/tmp/dmf/SignalPlus'
userremotedir = '/SignalPlus'
nevent ='100000'
ejob = '500'
sewhitelist = ''
output = 'signalplus.root'
weight = '1.'
ConfigHandler(output, parametersList, dataset, ejob, nevent, uiworkingdir, userremotedir, sewhitelist, weight)

dataset = '/SDDiJetsMinus_Pt30-pomwig/Spring10-START3X_V26_S09_E7TeV_L69E30_BX156-v1/GEN-SIM-RECO'
uiworkingdir = '/tmp/dmf/SignalMinus'
userremotedir = '/SignalMinus'
nevent ='100000'
ejob = '500'
sewhitelist = ''
output = 'signalminus.root'
weight = '1.'
ConfigHandler(output, parametersList, dataset, ejob, nevent, uiworkingdir, userremotedir, sewhitelist, weight)
...
# non-diffractive
#################
#dataset = '/QCD_Pt_15to3000_TuneZ2_Flat_7TeV_pythia6/Fall10-E7TeV_ProbDist_2010Data_BX156_START38_V12-v1/GEN-SIM-RECO'
#uiworkingdir = '/tmp/dmf/qcd_pt_15to3000'
#userremotedir = '/qcd_pt_15to3000'
#nevent ='5000000'
#ejob = '100000'
#sewhitelist = ''
#output = 'qcd_pt_15to3000.root'
#weight = '1.'
#ConfigHandler(output, parametersList, dataset, ejob, nevent, uiworkingdir, userremotedir, sewhitelist, weight)

#dataset = '/QCD_Pt_15to30_TuneZ2_7TeV_pythia6/Fall10-E7TeV_ProbDist_2010Data_BX156_START38_V12-v1/GEN-SIM-RECO'
#uiworkingdir = '/tmp/dmf/qcd_pt_15to30'
#userremotedir = '/qcd_pt_15to30'
#nevent ='1000000'
#ejob = '5000'
#sewhitelist = ''
...
#uiworkingdir = '/tmp/dmf/qcd_pt_30to50'
#userremotedir = '/qcd_pt_30to50'
#nevent ='1000000'
#ejob = '5000'
#sewhitelist = ''
...
#uiworkingdir = '/tmp/dmf/qcd_pt_50to80'
#userremotedir = '/qcd_pt_50to80'
#nevent ='1000000'
#ejob = '5000'
#sewhitelist = ''
...
#uiworkingdir = '/tmp/dmf/qcd_pt_80to120'
#userremotedir = '/qcd_pt_80to120'
#nevent ='1000000'
#ejob = '5000'
#sewhitelist = ''
...
#uiworkingdir = '/tmp/dmf/qcd_pt_120to170'
#userremotedir = '/qcd_pt_120to170'
#nevent ='1000000'
#ejob = '5000'
#sewhitelist = ''
...
#uiworkingdir = '/tmp/dmf/qcd_pt_170to300'
#userremotedir = '/qcd_pt_170to300'
#nevent ='1000000'
#ejob = '5000'
#sewhitelist = ''
...
#uiworkingdir = '/tmp/dmf/qcd_pt_300to470'
#userremotedir = '/qcd_pt_300to470'
#nevent ='1000000'
#ejob = '5000'
#sewhitelist = ''
